...
KEYPAD_enuErrorStatus KEYPAD_GetKey(u8 * Add_pKeyPressed)
{
    ...
    u8 Local_u8KEYPAD_ARR[ROWS_SIZE][COLUMN_SIZE] = KEYPAD_ARR;
    u8 Local_u8ColumnIndex,Local_u8RowIndix;
    u8 Local_u8ColumnArr[COLUMN_SIZE] = {KEYPAD_COLUMN1,KEYPAD_COLUMN2,KEYPAD_COLUMN3};
    u8 Local_u8RowArr[ROWS_SIZE] = {KEYPAD_ROW1,KEYPAD_ROW2,KEYPAD_ROW3};
    u8 Local_u8PinValue;
    ...
    else
    {
        for( Local_u8ColumnIndex = 0 ; Local_u8ColumnIndex < COLUMN_SIZE ; Local_u8ColumnIndex++ )
        {
            ...
            {
                DIO_enuGetPin( KEYPAD_PORT , &Local_u8PinValue);
